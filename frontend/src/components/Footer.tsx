...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/humanos',
      icon: (props: React.ComponentProps<'svg'>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              Générez, analysez et validez vos idées business avec l&apos;IA.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 dark:border-gray-700 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} HumanOS. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
