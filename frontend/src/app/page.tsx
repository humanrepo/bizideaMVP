          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl">
                Donnez vie à vos idées business avec l&apos;IA
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                BizIdea analyse le marché, identifie les opportunités et valide vos concepts business en quelques clics.
                Lancez votre projet avec confiance grâce à notre IA et notre communauté d&apos;entrepreneurs.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Link href="/communaute" className="text-sm font-semibold leading-6 text-gray-900 dark:text-white">
